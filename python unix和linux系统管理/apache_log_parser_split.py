...
to parse. It then parses the log file add generates a report which
...
def dictify_logline(line):
    """
    return a dictinary of the pertinent pieces of an apache combined log file
...
if __name__ == "__main__":
    ...
    try:
        ...
        print('You must specify a valid file to pares')
        print(__doc__)
        sys.exit(1)
