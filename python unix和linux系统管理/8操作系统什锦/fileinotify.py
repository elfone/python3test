...
class Controller(object):
    ...
    def run(self):
        ...
        PC = self.pclose
        # only wath these events
        # mask = EventsCodes.IN_CLOSE_WRITE | EventsCodes.IN_CLOSE_NOWRITE
        mask = EventsCodes.FLAG_COLLECTIONS['OP_FLAGS']['IN_CLOSE_WRITE'] | \
               EventsCodes.FLAG_COLLECTIONS['OP_FLAGS']['IN_CLOSE_NOWRITE']

        # wathc manager instance
        wm = WatchManager()
